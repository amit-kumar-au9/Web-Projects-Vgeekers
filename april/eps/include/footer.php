                        ...
                        <div class="kingster-footer-column kingster-item-pdlr kingster-column-15">
                            <div id="text-2" class="widget widget_text kingster-widget">
                                <div class="textwidget">
                                    <p>
                                    <center>
                                    <img src="asset/images/logo1.png" alt="" style="width: 100px;height:100px;"/>
                                       <br /> <span class="gdlr-core-space-shortcode" id="span_1dd7_10"></span>
                                        Elite Public School<br>
                                        Chakbalarampur/Devpur<br>
                                        P.O. & P.S.-Pakur<br>
                                        District- Pakur,
                                        Jharkhand, India
                                    </p>
                                    <p>
                                        <span id="span_1dd7_11">+91 <?php echo $row['phone1']; ?></span>
                                        <?php 
                                            if($row['phone2']!=""){
                                        ?>
                                                || <span id="span_1dd7_11">+91 <?php echo $row['phone2']; ?></span>
                                        <?php 
                                            }
                                        ?>
                                        <br> 
                                        ...
                                        <br /> 
                                        <a id="a_1dd7_8" href="mailto:<?php echo $row['email1']; ?>"><?php echo $row['email1']; ?></a>
                                        <?php 
                                            if($row['email2']!=""){
                                        ?>
                                                || <a id="a_1dd7_8" href="mailto:<?php echo $row['email2']; ?>"><?php echo $row['email2']; ?></a>
                                        <?php 
                                            }
                                        ?>
                                    </p>
                            ...
                            <div id="gdlr-core-custom-menu-widget-2" class="widget widget_gdlr-core-custom-menu-widget kingster-widget">
                                ...
                                <div class="menu-our-campus-container">
                                    <ul id="menu-our-campus" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-plain">
                                        ...
                                        <li class="menu-item"><a href="mess_director.php">Message From Director</a></li>
                                        <li class="menu-item"><a href="mess_principle.php">Message From Principal</a></li>
                            ...
                            <div id="gdlr-core-custom-menu-widget-3" class="widget widget_gdlr-core-custom-menu-widget kingster-widget">
                                ...
                                <div class="menu-campus-life-container">
                                    <ul id="menu-campus-life" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-plain">
                                        ...
                                        <li class="menu-item"><a href="teachers.php">Our Faculty</a></li>
                                        <li class="menu-item"><a href="attraction.php">Facilities and Attraction</a></li>
                            ...
                            <div id="gdlr-core-custom-menu-widget-4" class="widget widget_gdlr-core-custom-menu-widget kingster-widget">
                                ...
                                <div class="menu-academics-container">
                                    <ul id="menu-academics" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-plain">
                                        <li class="menu-item"><a href="curriculum.php">Curriculum</a></li>
                                        <li class="menu-item"><a href="library.php">Library and Facility Aid</a></li>
                                        <li class="menu-item"><a href="ad_info.php">Admission Information</a></li>
                                        <li class="menu-item"><a href="code.php">Code of Conduct</a></li>
                ...
                <div class="kingster-copyright-wrapper">
                    <div class="kingster-copyright-container kingster-container clearfix">
                        <div class="kingster-copyright-left kingster-item-pdlr">
                            <p class="text-capitalize">Copyright 2020 EPS Pakur. All rights reserved | Design by <a href="http://tech1one.com/">SSA TECHONE</a></p>
                        </div>
...
<!-- Mirrored from max-themes.net/demos/kingster/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Apr 2020 19:59:00 GMT -->
</html>