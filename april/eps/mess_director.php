...
<div class="kingster-page-title-wrap  kingster-style-medium kingster-center-align" style="padding: 0px 0px 0px 0px; background-image: url(./asset/images/index/home_back.jpg); background-size: cover">
    ...
    <div class="kingster-page-title-container kingster-container">
        <div class="kingster-page-title-content kingster-item-pdlr">
            ...
            <h1 class="kingster-page-title" >Message From The Director</h1></div>
    </div>
</div>
 <div class="kingster-breadcrumbs">
    <div class="kingster-breadcrumbs-container kingster-container">
        <div class="kingster-breadcrumbs-item kingster-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Kingster." href="index.php" class="home"><span property="name">Home</span></a>
            ...
            </span>&gt;<span property="itemListElement" typeof="ListItem"><span property="name">Messages/Message From The Director</span>
                        ...
                        <div class="gdlr-core-blog-item gdlr-core-item-pdb clearfix  gdlr-core-style-blog-image-no-space gdlr-core-item-pdlr" style="padding-bottom: 50px ;">
                            <div class="gdlr-core-blog-item-holder gdlr-core-js-2 clearfix" data-layout="fitrows">
                                ...
                                <div class="col-md-2 ">
                                    ...
                                    <img src="asset/images/<?php echo $row['dimage']; ?>" class="card-img-top" alt="..." style="width: 17rem;">
                                        <div class="card-body">
                                            <h6 class="card-title" style="color:#122140"><?php echo $row['dname']; ?></h6>
                                            <p class="card-text">THE DIRECTOR</p>
                                            <!--<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style='color:white'>About The Director</a>-->
                                        </div>
                                    </div>
                                    </p>
                                </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">About the Director</h5>
            ...
            <img src="asset/images/<?php echo $row['dimage']; ?>" class="card-img-top" alt="..." style="width: 17rem;">
            <div class="card-body">
            <h5 class="card-title" style="color:#dead25"><?php echo $row['dname']; ?></h5>
            <p class="card-text"><?php echo $row['dmessage'] ?></p>
            </div>
            </div>
            </center>
            </div>
