...
<?php include "conn.php";?>
  <div id="page-wrapper" style="background: white;scroll-behavior: smooth;">
    <div class="main-page" style="background: white;">
      <center><h2 class="title1" style="color: red;">Add Lower Banner</h2></center>
      <div class="forms">
        <form style="margin: 10px" method="post" enctype="multipart/form-data">
          <div class="form-group" style="width: 50%">
            <label for="exampleInputEmail1">Banner Image</label>
            <input type="file" class="form-control"  required name="UploadImage"  style="background:lightgrey">
          </div>
      ...
      <center><h2 class="title1" id="view" style="color: red;">View Lower Banner</h2></center>
...
<?php 
    ...
    if ($file_upload) 
    {
      ...
      else
      {
        $checkQuery = "INSERT into  banner(image) VALUES('".$file_name."')";
          ...
          {
            echo "<script>window.location.href='add_bot_banner.php';</script>";
          }
          else
          {
            echo "<script>window.location.href='add_bot_banner.php';</script>";
  ...
  { 
    ...
    {
      echo "<scriptwindow.location.href='add_bot_banner.php';</script>";
    }
  }
?>
