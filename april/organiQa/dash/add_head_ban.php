...
<?php include "conn.php";?>
  <div id="page-wrapper" style="background: white;scroll-behavior: smooth;">
    <div class="main-page" style="background: white;">
      <center><h2 class="title1" style="color: red;">Add Top Banner</h2></center>
      <div class="forms">
      ...
      <center><h2 class="title1" id="view" style="color: red;">View Top Banner</h2></center>
...
<?php 
  ...
  { 
    ...
    if ($file_upload) 
    {
      ...
      else
      {
        $checkQuery = "INSERT into  banner(image) VALUES('".$file_name."')";
          ...
          {
            echo "<script>window.alert('Head Banner Added');window.location.href='add_head_ban.php';</script>";
          }
          else
          {
            echo "<script>window.alert('Please Re Upload Image');window.location.href='add_head_ban.php';</script>";
          }
      }
    }
    ...
    {
      echo "<script>window.alert('Please Retry');window.location.href='add_head_ban.php';</script>";
    }
  }
  ...
  { 
    ...
    if ($file_upload) 
    {
      ...
      $checkQuery = "UPDATE banner SET image = '".$file_name."' WHERE id = 1";
        if (mysqli_query($con, $checkQuery)) 
        {
          echo "<script>window.alert('Head Banner updated');window.location.href='add_head_ban.php';</script>";
        }
