<?php include "include/header.php";?>
	<div id="page-wrapper" style="background:white">
		<div class="main-page" style="background:  white">
			...
			<div class="forms">
				<form style="margin: 10px" action="add_pro.php"  method="post" enctype="multipart/form-data">
          <div class="form-group" style="width: 50%">
            <label for="exampleInputEmail1">S.NO</label>
            <input type="number" class="form-control" placeholder="Enter S.No">
          </div>
          <div class="form-group" style="width: 50%">
          ...
          <div class="form-group" style="width: 50%">
            ...
            <input type="number" class="form-control" placeholder="Enter Product Cost" name="cost">
          </div>
          <div class="form-group" style="width: 50%">
          ...
          <div class="form-group" style="width: 50%">
            ...
            <input type="number" class="form-control" placeholder="Discount(in percentage)" name="discount">
          </div>
          <div class="form-group" style="width: 50%">
            <label for="exampleInputEmail1">Product Image</label>
            <input type="file" class="form-control" style="background:lightgrey" name="photo">
          </div>
          <div class="form-group" style="width: 50%">
            <label for="exampleInputPassword1">Product heading</label>
            <input type="text" class="form-control" placeholder="Product heading" name="heading">
          </div>
          <div class="form-group" style="width: 50%;">
