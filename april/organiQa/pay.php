...
<?php
  ...
  $num=$_SESSION['phone'];
  $total=$_POST['total'];
  $query1="SELECT * FROM signup WHERE phone='$num'";
  ...
  $id= $result1['id'];
  if($id!=""){
    $sql="UPDATE signup SET first_name='$fname', last_name='$lname', email='$email',address='$add', state='$state', city='$city' ,pin='$pin' WHERE id='$id'";
  ...
  $sql1="SELECT * FROM detail WHERE id=5";
...
<form action="enter_order.php" method="POST">
  ...
  data-amount="<?php echo $order->amount?>" // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise    data-currency="INR" 
  data-order_id="<?php echo $order->id?>"   
  data-buttontext="Proceed For pay"    
  data-name="OrganiQa"    
  data-description="Total Order"    
  data-image="asset/images/<?php echo $result1['image']?>"    
