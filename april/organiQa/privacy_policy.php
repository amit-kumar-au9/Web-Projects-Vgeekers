  ...
  <body class="goto-here">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Privacy Policy</span></p>
            <h1 class="mb-0 bread" style="color: black">Privacy Policy</h1>
          </div>
        </div>
      </div>
    </div>
    <center>
      <div class="col-md-7 heading-section ftco-animate text-center">
        <span class="subheading" style="font-size: 40px;" style="color: yellowgreen">Privacy Policy</span>
      </div>
    </center>
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
		...
		<?php
                $query="SELECT * FROM detail WHERE id=2";
