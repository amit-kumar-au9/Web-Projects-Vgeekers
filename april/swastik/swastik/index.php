        ...
        <div class="formBody">
            <div>
                <div class="formInput form-group">
                    <div>Name</div>
                    <input type="text" class="form-control" maxlength="35" placeholder="enter name">
                </div>
                <div class="formInput">
                    <div>Phone</div>
                    <input type="number" maxlength="10" placeholder="enter phone">
                </div>
                	<div class="formInput">
                ...
                <br>
                 <div class="formInput">
                    <div>Enter OTP</div>
                    <input type="number" maxlength="10" placeholder="enter otp">
                </div>
            </div>
            <button class="btn btn-outline-danger" style="width: 60%">Login</button>
        </div>
    </div>
</div>
