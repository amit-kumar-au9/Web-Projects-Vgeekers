    ...
    <aside class="sidebar-left" style="overflow-y:scroll">
      <nav class="navbar navbar-inverse">
        <div class="navbar-header">
          ...
          <h6 style="padding-left:10px"><a class="navbar-brand" href="admin.php" style="margin:5px;"><span><img src="../asset/images/logo1.png" class="logo"></span>&mdash;Swastik&mdash;<span class="dashboard_text" style="margin-left:13px;">Dashboard</span></a></h6>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="view_phase1.php">
                <i class="fas fa-users"></i> <span>Phase 1</span>
              </a>
            </li>
            <li>
              <a href="view_phase2.php">
                <i class="fas fa-users"></i> <span>Phase 2</span>
              </a>
            </li>
            <li>
              <a href="view_phase3.php">
                <i class="fas fa-users"></i> <span>Phase 3</span>
              </a>
            </li>
            <li>
              <a href="logout.php">
