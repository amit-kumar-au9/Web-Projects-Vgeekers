...
<div id="page-wrapper">
			<div class="main-page">
				<br>
        <center><h2 class="title1" style="color: red;">ADD SUB ADMINS</h2></center>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button id="button1id" name="button1id" class="btn btn-success" data-toggle="modal" data-target="#exampleModal1" >Create</button>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <h4>Are you sure you want to create a new sub-admin?</h4>
         </div>
