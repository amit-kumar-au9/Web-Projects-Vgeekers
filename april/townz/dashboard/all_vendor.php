		...
		<table class="responstable">
		  	...
		  	<tbody>
		  		<?php 
					...
					$checkQuery = "SELECT * FROM vendor_details JOIN wallet ON vendor_details.user_id = wallet.user_id ORDER BY vendor_details.user_id DESC";
