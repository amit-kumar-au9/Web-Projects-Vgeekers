...
<div id="page-wrapper">
    <div class="main-page">
        <br>
        <center><h2 class="title1" style="color: red;">EDIT VENDORS PROFILE</h2></center>
...
<div class="form-group">
<label class="col-md-3 control-label" for="textinput">Services Prices </label>  
<div class="col-md-4">
<input id="textinput" name="textinput" type="number" placeholder="Services Prices" class="form-control input-md">
</div>
        
<label class="col-md-1 control-label" for="textinput">Commission</label>  
<div class="col-md-4">
<input id="textinput" name="textinput" type="email" placeholder="Comission" class="form-control input-md">
</div>
</div>
<!-- Textarea -->
<div class="form-group">
...
<div class="modal-footer">
  <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="yes()">Yes</button>
