...
<?php 
  ...
  $checkQuery = "SELECT * FROM basic_data WHERE id = 4";
...
<div id="page-wrapper">
  <div class="main-page">
    <form method="post">
      <br>
      <center><h2 class="title1" style="color:red;">Update Terms of User</h2>
...
<?php 
  ...
  if(isset($_POST['update'])){
    ...
    $checkQuery = "UPDATE basic_data SET content = '".$content."' WHERE id = 4";
    mysqli_query($conn, $checkQuery);
    echo "<script>window.location.href='update_terms_of_use.php';</script>";
