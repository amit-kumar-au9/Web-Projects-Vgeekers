...
<?php 
  ...
  $checkQuery = "SELECT * FROM basic_data WHERE id = 1";
...
<div id="page-wrapper">
  <div class="main-page">
    <form method="post">
      <br>
      <center><h2 class="title1" style="color:red;">Update Training Center</h2>
...
<?php 
  ...
  if(isset($_POST['update'])){
    ...
    echo "<script>window.location.href='update_training_center.php';</script>";
