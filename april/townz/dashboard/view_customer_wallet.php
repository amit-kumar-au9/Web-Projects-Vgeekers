...
<?php  
    ...
    $checkQuery = "SELECT * FROM customer_wallet WHERE user_id = '".$user_id."'";
  ...
  <div class="main-page">
    ...
    <table class="responstable">
        ...
        <tbody>
          <?php 
            include 'include/connection.php';
            $checkQuery = "SELECT * FROM order_txn_customer WHERE wallet_id = '".$wallet_id."' ORDER BY id DESC";
            $checkResult = mysqli_query($conn, $checkQuery);
            $no = 1;
...
<?php 
  ...
  if(isset($_POST['updateWallet'])){
    ...
    $checkQuery = "UPDATE customer_wallet SET total_balance = '".$total_balance."' WHERE user_id = '".$user_id."'";
