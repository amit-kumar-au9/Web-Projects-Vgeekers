              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area" style="height: auto !important">
                    <form class="addAdmin" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <button class="btn btn-primary" type="submit" id="btnSubmit1" name="addAdmin">Add Admin</button>
