<?php include 'include/header.php'; ?>
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Add Cash Flow</h1>

          <div class="row" id="uploadCashFlow">
            <!-- Area Chart -->
            <div class="col-xl-12 col-lg-12" id="content">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Upload Cash Flow</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="chart-area" style="height: auto !important">
                    <form class="uploadCashFlow" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="number" name="billing_amount" min="0" class="form-control" placeholder="Enter Amount" required>
                        </div>

                        <div class="form-group col-md-12">
                          <label style="color: black">Description</label>
                          <textarea type="text" name="dsc" class="form-control" placeholder="Enter Description" rows="3"></textarea>
                        </div>

                      </div>
                        <button class="btn btn-primary" type="submit" id="btnSubmit1">Upload</button>
...
<script> 
  ...
  $('form.uploadCashFlow').submit(function(e){
      $('#load').show();
    $('#btnSubmit1').hide();
    e.preventDefault();
