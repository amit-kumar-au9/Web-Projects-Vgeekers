<?php include 'include/header.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Site</h1>
          </div>
                    ...
                    <form class="addSite" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="form-group col-md-12">
                          <label style="color: black">Description <span style="color: red">*</span></label>
                        ...
                        <button class="btn btn-primary" type="submit" id="btnSubmit1" name="addSite">Add</button>
