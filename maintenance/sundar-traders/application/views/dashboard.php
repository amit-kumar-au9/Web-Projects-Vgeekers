                ...
                <div class="col-md-12 today">
                  ...
                  <div class="col-md-2 col-xs-5">
                    <div class="small-box bg-yellow">
                      <div class="inner">
                        <?php 
                          if(isset($todayExpenses[0]->item)){
                            echo "<span class='h-font'>".$this->session->userdata('symbol').$todayExpenses[0]->item."</span>"; 
                          }
                          else {
                            echo "<span class='h-font'>".$this->session->userdata('symbol')."0</span>";
                          }
                      ...
                      <span class="small-box-footer"><?php echo 'Expenses Value'; ?></span>
                    </div>
                  </div><!-- /.col -->
                </div><!-- /.col 12 -->
                ...
                <div class="col-md-12 week">
                  ...
                  <div class="col-md-2 col-xs-5">
                    <div class="small-box bg-yellow">
                      <div class="inner">
                        <?php 
                          if(isset($weekExpenses[0]->item)){
                            echo "<span class='h-font'>".$this->session->userdata('symbol').$weekExpenses[0]->item."</span>"; 
                          }
                          else {
                            echo "<span class='h-font'>".$this->session->userdata('symbol')."0</span>";
                          }
                ...
                <div class="col-md-12 month">
                  ...
                  <div class="col-md-2 col-xs-5">
                    <div class="small-box bg-yellow">
                      <div class="inner">
                        <?php 
                          if(isset($monthExpenses[0]->item)){
                            echo "<span class='h-font'>".$this->session->userdata('symbol').$monthExpenses[0]->item."</span>"; 
                          }
                          else {
                            echo "<span class='h-font'>".$this->session->userdata('symbol')."0<span class='h-font'>";
                          }
                ...
                <div class="col-md-12 year">
                  ...
                  <div class="col-md-2 col-xs-5">
                    <div class="small-box bg-yellow">
                      <div class="inner">
                        <?php 
                          if(isset($yearExpenses[0]->item)){
                            echo "<span class='h-font'>".$this->session->userdata('symbol').$yearExpenses[0]->item."</span>"; 
                          }
                          else {
                            echo "<span class='h-font'>".$this->session->userdata('symbol')."0</span>";
                          }
                ...
                <div class="col-md-12 all">
                  ...
                  <div class="col-md-2 col-xs-5">
                    <div class="small-box bg-yellow">
                      <div class="inner">
                        <?php 
                          if(isset($allExpenses[0]->item)){
                            echo "<span class='h-font'>".$this->session->userdata('symbol').$allExpenses[0]->item."</span>"; 
                          }
                          else {
                            echo "<span class='h-font'>".$this->session->userdata('symbol')."0</span>";
                          }
