  <footer class="main-footer">
    ...
    <strong><?php echo $this->lang->line('dashboard_copyright'); ?> &copy; <?php echo date('Y'); ?> <a href="http://vgeekers.com" target="_blank">VGeekers</a>.</strong> All <?php echo $this->lang->line('dashboard_rights_reserved'); ?>
  </footer>
<!-- ./wrapper -->
<!-- Control Sidebar -->
