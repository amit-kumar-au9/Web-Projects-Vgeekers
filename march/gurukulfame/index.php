      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-8 mt-lg-5 text-center">
            <h1 class="text-uppercase mb-5" data-aos="fade-up">Something about gurukul or Studies</h1>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 text-center">
            <p class="mb-4">
              ...
              <span>Address of Gurukul,India</span>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-4">
        ...
        <div class="row">
          <div class="col-md-12 mb-5">
            ...
            <form class="p-5 bg-white" action="contactUs.php" method="post">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="7" name="message" class="form-control" placeholder="Write your notes or questions here..."></textarea>
                </div>
              </div>
