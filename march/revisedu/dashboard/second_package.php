                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="white-box">
                            ...
                            $checkOffers = "SELECT * FROM package WHERE type = '2'";
...
if(isset($_POST['SubmitButton'])){ //check if form was submitted
    ...
    if ($file_upload) {
        $checkQuery = "INSERT INTO package (name, description, image, type) VALUES ('".$name."', '".$description."', '".$file_name."', '2')";
...
if(isset($_POST['UpdateName'])){
    $name = $_POST['name'];
    $description = $_POST['description'];
    $checkQuery= "UPDATE package_name SET name='".$name."', description = '".$description."' WHERE id=2 ";
    $checkResult=mysqli_query($conn, $checkQuery);
    $page = $_SERVER['PHP_SELF'];
    $sec = "1";
}
