    ...
    ?>
            ...
            <div class="row">
                ...
                <div class="portfolio-sildes owl-carousel">
                    ...
                    <div class="single-portfolio-slide animated bounceInLeft">
                        <img src="dashboard/images/package/<?php echo $row['image']; ?>">
                        <!-- Overlay Effect -->
        ...
        <div class="container">
           <section class="customer-logos slider">
            ...
            ?>
                    <div class="slide">
                        <img src="dashboard/images/offer/<?php echo $row['image'];?>">
                    </div>
            <?php 
                }
            ?>
            ...
            <div class="row align-items-center animated bounceInUp mb-40">
                ...
                <div class="col-12 col-md-6 col-xs-6">
                    <div class="about-us-thumbnail">
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/bZxtKxiA2qo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <!-- Video Area -->
