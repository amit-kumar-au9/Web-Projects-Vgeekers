            ...
            <div class="container-fluid">
                ...
                <div class="row" style="padding-top: 200px">
                    ...
                    <div class="col-md-4 col-xs-4">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="loginPage.php" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Username</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Johnathan Doe" class="form-control form-control-line" name="username"> 
                                    </div>
                                </div>
                                <div class="form-group">
